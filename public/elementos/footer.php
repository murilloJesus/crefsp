  	<!-- FOOTER -->
	<div id="rodapé" class="footer-lg" style="background: url('http://netpchost.tec.br/storage/app/imagens/9b1b171d05ccb33fa89988b0900787ac.jpeg'); background-size: cover;">
		<div class="container">
					...
					<h5>Seccionais</h5>
						<?php
					        ...
					        foreach ($home['seccionais'] as $seccional) {
					        	echo "<a href='$seccional[id]'> $seccional[name] </a><br />";
